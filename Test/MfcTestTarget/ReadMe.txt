================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MfcTestTarget プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MfcTestTarget には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MfcTestTarget アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MfcTestTarget.vcxproj
...
MfcTestTarget.h
   ...
   CMfcTestTargetApp アプリケーション クラスを宣言します。

MfcTestTarget.cpp
   これは、アプリケーション クラス CMfcTestTargetApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MfcTestTarget.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MfcTestTarget.rc に含まれていま
   す。

res\MfcTestTarget.rc2
...
MfcTestTargetDlg.h, MfcTestTargetDlg.cpp - ダイアログ
   これらのファイルは CMfcTestTargetDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MfcTestTarget.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MfcTestTarget.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
